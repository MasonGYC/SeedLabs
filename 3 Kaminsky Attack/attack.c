...
int main()
{
    ...
    while (1)
    {
        ...
        int nu_pkt = 10000; // Send 10000 response packets per query

        while (nu_pkt>0)
        {
            transaction_id = rand() % 65536; // 2^16
 ...
 * Add arguments to the function definition if needed.
 * */
void send_dns_response(char *ip_resp, int pkt_size, char *name, int transaction_id)
{
